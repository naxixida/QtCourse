...
static constexpr auto qt_meta_stringdata_CLASSCustomPlainTextEditENDCLASS = QtMocHelpers::stringData(
    "CustomPlainTextEdit"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCustomPlainTextEditENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomPlainTextEditENDCLASS_t qt_meta_stringdata_CLASSCustomPlainTextEditENDCLASS = {
    {
        QT_MOC_LITERAL(0, 19)   // "CustomPlainTextEdit"
    },
    "CustomPlainTextEdit"
};
