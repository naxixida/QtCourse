...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSearchDialogENDCLASS_t qt_meta_stringdata_CLASSSearchDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 8),  // "findText"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 4),  // "text"
        QT_MOC_LITERAL(28, 13),  // "caseSensitive"
        QT_MOC_LITERAL(42, 10),  // "searchDown"
        QT_MOC_LITERAL(53, 21)   // "on_btFindNext_clicked"
    },
    "SearchDialog",
    "findText",
    "",
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->findText((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[3]))); break;
        ...
        {
            using _t = void (SearchDialog::*)(const QString & , bool , bool );
            if (_t _q_method = &SearchDialog::findText; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchDialog::findText(const QString & _t1, bool _t2, bool _t3)
{
